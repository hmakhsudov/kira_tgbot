...
from models import Recipe, Ingredient, History, Category
...
class DbService:
    ...
    def save_choice(self, choice, recipe_id, user_id):
        history = History(recipe_id=recipe_id, user_id=user_id, choice=choice)
